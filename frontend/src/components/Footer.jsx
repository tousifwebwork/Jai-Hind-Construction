  ...
  return (
    <footer className="relative overflow-hidden bg-[#17181A] px-6 pt-20 text-[#F4F2EC] md:px-12 lg:px-20">
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(to right, #F4F2EC 1px, transparent 1px), linear-gradient(to bottom, #F4F2EC 1px, transparent 1px)',
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid gap-12 border-b border-white/10 pb-14 md:grid-cols-4">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              <Compass size={22} strokeWidth={1.5} className="text-[#E2A33B]" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              <li className="flex items-start gap-2">
                ...
                <span>412 Foundry St, Portland, OR 97201</span>
              </li>
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:projects@meridianbuild.co" className="hover:text-white">
        ...
        <div className="flex flex-col gap-4 py-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="grid grid-cols-3 divide-x divide-white/10 border border-white/10 sm:grid-cols-6">
            {titleBlock.map((cell) => (
